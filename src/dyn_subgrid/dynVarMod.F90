...
# 209 "dynVarMod.F90.in"
  end subroutine set_metadata


  !-----------------------------------------------------------------------
# 213 "dynVarMod.F90.in"
...
# 237 "dynVarMod.F90.in"
  end function get_data_shape

  !-----------------------------------------------------------------------
# 240 "dynVarMod.F90.in"
...
# 258 "dynVarMod.F90.in"
  end subroutine get_att

  !-----------------------------------------------------------------------
# 261 "dynVarMod.F90.in"

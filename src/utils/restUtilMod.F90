...
# 26 "restUtilMod.F90.in"
  interface restartvar
     ...
     !TYPE int,double
     module procedure restartvar_2d_int_bounds
     !TYPE int,double
...
# 60 "restUtilMod.F90.in"
  interface set_missing_vals_to_constant
     !DIMS 1,2
     module procedure set_missing_vals_to_constant_1d
     !DIMS 1,2
     module procedure set_missing_vals_to_constant_2d
...
# 72 "restUtilMod.F90.in"
contains

  !-----------------------------------------------------------------------
  !DIMS 0
  !TYPE text,int,double
# 77 "restUtilMod.F90.in"
...
# 353 "restUtilMod.F90.in"
  ...
  !-----------------------------------------------------------------------
  !TYPE int,double
# 357 "restUtilMod.F90.in"
  subroutine restartvar_2d_int_bounds(ncid, flag, varname, xtype, &
    ...
    character(len=*) , intent(in)           :: long_name        ! long name for variable
    character(len=*) , intent(in)           :: interpinic_flag  ! interpolate variable using interpinic ('interp', 'copy', 'skip' or 'area': see iflag meanings defined at the top of this module)
    integer(i4)          , pointer              :: data(:,:)        ! raw data
    logical          , intent(out)          :: readvar          ! was var read?
...
# 511 "restUtilMod.F90.in"
  end subroutine restartvar_2d_int_bounds
  !TYPE int,double
# 357 "restUtilMod.F90.in"
...
# 546 "restUtilMod.F90.in"
  end subroutine set_missing_from_template

  !-----------------------------------------------------------------------
# 549 "restUtilMod.F90.in"
  subroutine set_grc_field_from_col_field(bounds, ncid, varname, data_grc, readvar)
    ...
    deallocate(data_col)
# 595 "restUtilMod.F90.in"
  end subroutine set_grc_field_from_col_field

  !-----------------------------------------------------------------------
  ! DIMS 1,2
# 599 "restUtilMod.F90.in"
  subroutine set_missing_vals_to_constant_1d(data, val)
    !
    ! !DESCRIPTION:
    ...
    !
    ! !ARGUMENTS:
    real(r8), intent(inout) :: data(:)  ! variable to modify
    real(r8), intent(in)    :: val           ! value to replace any NaNs or spvals
    !
    ! !LOCAL VARIABLES:

    character(len=*), parameter :: subname = 'set_missing_vals_to_constant_1d'
    !-----------------------------------------------------------------------
...
# 622 "restUtilMod.F90.in"
  end subroutine set_missing_vals_to_constant_1d
  ! DIMS 1,2
# 599 "restUtilMod.F90.in"
  subroutine set_missing_vals_to_constant_2d(data, val)
    !
    ! !DESCRIPTION:
    ! Set missing values (NaN or spval) of a restart field to some constant value
    !
    ...
    character(len=*), parameter :: subname = 'set_missing_vals_to_constant_2d'
    !-----------------------------------------------------------------------
...
# 622 "restUtilMod.F90.in"
  end subroutine set_missing_vals_to_constant_2d

  !-----------------------------------------------------------------------
# 625 "restUtilMod.F90.in"
...
# 660 "restUtilMod.F90.in"
  end subroutine missing_field_possibly_abort

  !-----------------------------------------------------------------------
# 663 "restUtilMod.F90.in"

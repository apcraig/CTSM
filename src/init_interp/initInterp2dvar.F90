...
# 39 "initInterp2dvar.F90.in"
   contains
     ! Public routines
     generic :: readvar => readvar_int, readvar_double
     !TYPE int,double
     procedure :: readvar_int
     !TYPE int,double
     procedure :: readvar_double

     generic :: writevar => writevar_int, writevar_double
     !TYPE int,double
     procedure :: writevar_int
     !TYPE int,double
     procedure :: writevar_double

     generic :: readlevel => readlevel_int, readlevel_double  ! read one level
     !TYPE int,double
     procedure :: readlevel_int
     !TYPE int,double
     procedure :: readlevel_double
...
# 136 "initInterp2dvar.F90.in"
  ...
  !-----------------------------------------------------------------------
  !TYPE int,double
# 144 "initInterp2dvar.F90.in"
  subroutine readvar_int(this, data)
    !
    ! !DESCRIPTION:
    ...
    integer(i4), pointer, intent(out) :: data(:,:)   ! [vec, lev]
    !
    ! !LOCAL VARIABLES:
    integer(i4), pointer :: data_transpose(:,:) ! transpose of data array if switchdim is true
...
# 200 "initInterp2dvar.F90.in"
  end subroutine readvar_int
  !TYPE int,double
# 144 "initInterp2dvar.F90.in"
  subroutine readvar_double(this, data)
    !
    ! !DESCRIPTION:
    ! Reads variable from file.
    !
    ...
    ! 'this' is intent(inout) for the sake of ncid
    class(interp_2dvar_type), intent(inout) :: this
    real(r8), pointer, intent(out) :: data(:,:)   ! [vec, lev]
    !
    ! !LOCAL VARIABLES:
    real(r8), pointer :: data_transpose(:,:) ! transpose of data array if switchdim is true
...
# 200 "initInterp2dvar.F90.in"
  end subroutine readvar_double

  !-----------------------------------------------------------------------
  !TYPE int,double
# 204 "initInterp2dvar.F90.in"
  subroutine writevar_int(this, data)
    !
    ! !DESCRIPTION:
    ...
    ! 'this' is intent(inout) for the sake of ncid
    class(interp_2dvar_type), intent(inout) :: this
    integer(i4), pointer, intent(in) :: data(:,:)   ! [vec, lev]
    !
    ! !LOCAL VARIABLES:
...
# 234 "initInterp2dvar.F90.in"
  end subroutine writevar_int
  !TYPE int,double
# 204 "initInterp2dvar.F90.in"
  subroutine writevar_double(this, data)
    !
    ! !DESCRIPTION:
    ! Writes variable to file.
    !
    ...
    ! 'this' is intent(inout) for the sake of ncid
    class(interp_2dvar_type), intent(inout) :: this
    real(r8), pointer, intent(in) :: data(:,:)   ! [vec, lev]
    !
    ! !LOCAL VARIABLES:
...
# 234 "initInterp2dvar.F90.in"
  ...
  !-----------------------------------------------------------------------
  !TYPE int,double
# 238 "initInterp2dvar.F90.in"
  subroutine readlevel_int(this, data, level)
    !
    ! !DESCRIPTION:
...
# 293 "initInterp2dvar.F90.in"
  end subroutine readlevel_int
  !TYPE int,double
# 238 "initInterp2dvar.F90.in"
  subroutine readlevel_double(this, data, level)
    !
    ! !DESCRIPTION:
    ! Reads one level of variable from file.
    !
...
# 293 "initInterp2dvar.F90.in"
  end subroutine readlevel_double

# 295 "initInterp2dvar.F90.in"
...
# 301 "initInterp2dvar.F90.in"
  end function get_varname

# 303 "initInterp2dvar.F90.in"
...
# 309 "initInterp2dvar.F90.in"
  end function get_vec_dimname

# 311 "initInterp2dvar.F90.in"
